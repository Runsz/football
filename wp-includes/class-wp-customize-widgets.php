...
final class WP_Customize_Widgets {
	...
	public function print_styles() {
		/** This action is documented in bench/admin-header.php */
	...
	public function print_footer_scripts() {
		/** This action is documented in bench/admin-footer.php */
	...
	public function get_available_widgets() {
		...
		require_once ABSPATH . 'bench/includes/widgets.php'; // For next_widget_id_number().
