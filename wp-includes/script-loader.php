...
function wp_tinymce_inline_scripts() {
	...
	/** This filter is documented in bench/includes/media.php */
...
function wp_default_scripts( $scripts ) {
	...
	$scripts->default_dirs    = array( '/bench/js/', '/wp-includes/js/' );
	...
	$scripts->add( 'common', "/bench/js/common$suffix.js", array( 'jquery', 'hoverIntent', 'utils' ), false, 1 );
	...
	$scripts->add( 'editor', "/bench/js/editor$suffix.js", array( 'utils', 'jquery' ), false, 1 );
	...
	$scripts->add( 'revisions', "/bench/js/revisions$suffix.js", array( 'wp-backbone', 'jquery-ui-slider', 'hoverIntent' ), false, 1 );
	...
	$scripts->add( 'code-editor', "/bench/js/code-editor$suffix.js", array( 'jquery', 'wp-codemirror', 'underscore' ) );
	$scripts->add( 'wp-theme-plugin-editor', "/bench/js/theme-plugin-editor$suffix.js", array( 'common', 'wp-util', 'wp-sanitize', 'jquery', 'jquery-ui-core', 'wp-a11y', 'underscore' ) );
	...
	$scripts->add( 'password-strength-meter', "/bench/js/password-strength-meter$suffix.js", array( 'jquery', 'zxcvbn-async' ), false, 1 );
	did_action( 'init' ) && $scripts->localize(
	...
	$scripts->add( 'application-passwords', "/bench/js/application-passwords$suffix.js", array( 'jquery', 'wp-util', 'wp-api-request', 'wp-date', 'wp-i18n', 'wp-hooks' ), false, 1 );
	$scripts->set_translations( 'application-passwords' );

	$scripts->add( 'auth-app', "/bench/js/auth-app$suffix.js", array( 'jquery', 'wp-api-request', 'wp-i18n', 'wp-hooks' ), false, 1 );
	$scripts->set_translations( 'auth-app' );

	$scripts->add( 'user-profile', "/bench/js/user-profile$suffix.js", array( 'jquery', 'password-strength-meter', 'wp-util' ), false, 1 );
	...
	$scripts->add( 'language-chooser', "/bench/js/language-chooser$suffix.js", array( 'jquery' ), false, 1 );

	$scripts->add( 'user-suggest', "/bench/js/user-suggest$suffix.js", array( 'jquery-ui-autocomplete' ), false, 1 );
	...
	$scripts->add( 'word-count', "/bench/js/word-count$suffix.js", array(), false, 1 );

	$scripts->add( 'media-upload', "/bench/js/media-upload$suffix.js", array( 'thickbox', 'shortcode' ), false, 1 );
	...
	$scripts->add( 'customize-controls', "/bench/js/customize-controls$suffix.js", array( 'customize-base', 'wp-a11y', 'wp-util', 'jquery-ui-core' ), false, 1 );
	did_action( 'init' ) && $scripts->localize(
		'customize-controls',
	...
	$scripts->add( 'customize-widgets', "/bench/js/customize-widgets$suffix.js", array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-droppable', 'wp-backbone', 'customize-controls' ), false, 1 );
	...
	$scripts->add( 'customize-nav-menus', "/bench/js/customize-nav-menus$suffix.js", array( 'jquery', 'wp-backbone', 'customize-controls', 'accordion', 'nav-menu', 'wp-sanitize' ), false, 1 );
	...
	$scripts->add( 'accordion', "/bench/js/accordion$suffix.js", array( 'jquery' ), false, 1 );
	...
	if ( is_admin() ) {
		$scripts->add( 'admin-tags', "/bench/js/tags$suffix.js", array( 'jquery', 'wp-ajax-response' ), false, 1 );
		$scripts->set_translations( 'admin-tags' );

		$scripts->add( 'admin-comments', "/bench/js/edit-comments$suffix.js", array( 'wp-lists', 'quicktags', 'jquery-query' ), false, 1 );
		...
		$scripts->add( 'xfn', "/bench/js/xfn$suffix.js", array( 'jquery' ), false, 1 );

		$scripts->add( 'postbox', "/bench/js/postbox$suffix.js", array( 'jquery-ui-sortable', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'postbox' );

		$scripts->add( 'tags-box', "/bench/js/tags-box$suffix.js", array( 'jquery', 'tags-suggest' ), false, 1 );
		$scripts->set_translations( 'tags-box' );

		$scripts->add( 'tags-suggest', "/bench/js/tags-suggest$suffix.js", array( 'jquery-ui-autocomplete', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'tags-suggest' );

		$scripts->add( 'post', "/bench/js/post$suffix.js", array( 'suggest', 'wp-lists', 'postbox', 'tags-box', 'underscore', 'word-count', 'wp-a11y', 'wp-sanitize', 'clipboard' ), false, 1 );
		$scripts->set_translations( 'post' );

		$scripts->add( 'editor-expand', "/bench/js/editor-expand$suffix.js", array( 'jquery', 'underscore' ), false, 1 );

		$scripts->add( 'link', "/bench/js/link$suffix.js", array( 'wp-lists', 'postbox' ), false, 1 );

		$scripts->add( 'comment', "/bench/js/comment$suffix.js", array( 'jquery', 'postbox' ), false, 1 );
		$scripts->set_translations( 'comment' );

		$scripts->add( 'admin-gallery', "/bench/js/gallery$suffix.js", array( 'jquery-ui-sortable' ) );

		$scripts->add( 'admin-widgets', "/bench/js/widgets$suffix.js", array( 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-droppable', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'admin-widgets' );

		$scripts->add( 'media-widgets', "/bench/js/widgets/media-widgets$suffix.js", array( 'jquery', 'media-models', 'media-views', 'wp-api-request' ) );
		$scripts->add_inline_script( 'media-widgets', 'wp.mediaWidgets.init();', 'after' );

		$scripts->add( 'media-audio-widget', "/bench/js/widgets/media-audio-widget$suffix.js", array( 'media-widgets', 'media-audiovideo' ) );
		$scripts->add( 'media-image-widget', "/bench/js/widgets/media-image-widget$suffix.js", array( 'media-widgets' ) );
		$scripts->add( 'media-gallery-widget', "/bench/js/widgets/media-gallery-widget$suffix.js", array( 'media-widgets' ) );
		$scripts->add( 'media-video-widget', "/bench/js/widgets/media-video-widget$suffix.js", array( 'media-widgets', 'media-audiovideo', 'wp-api-request' ) );
		$scripts->add( 'text-widgets', "/bench/js/widgets/text-widgets$suffix.js", array( 'jquery', 'backbone', 'editor', 'wp-util', 'wp-a11y' ) );
		$scripts->add( 'custom-html-widgets', "/bench/js/widgets/custom-html-widgets$suffix.js", array( 'jquery', 'backbone', 'wp-util', 'jquery-ui-core', 'wp-a11y' ) );

		$scripts->add( 'theme', "/bench/js/theme$suffix.js", array( 'wp-backbone', 'wp-a11y', 'customize-base' ), false, 1 );

		$scripts->add( 'inline-edit-post', "/bench/js/inline-edit-post$suffix.js", array( 'jquery', 'tags-suggest', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'inline-edit-post' );

		$scripts->add( 'inline-edit-tax', "/bench/js/inline-edit-tax$suffix.js", array( 'jquery', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'inline-edit-tax' );

		$scripts->add( 'plugin-install', "/bench/js/plugin-install$suffix.js", array( 'jquery', 'jquery-ui-core', 'thickbox' ), false, 1 );
		$scripts->set_translations( 'plugin-install' );

		$scripts->add( 'site-health', "/bench/js/site-health$suffix.js", array( 'clipboard', 'jquery', 'wp-util', 'wp-a11y', 'wp-api-request', 'wp-url', 'wp-i18n', 'wp-hooks' ), false, 1 );
		$scripts->set_translations( 'site-health' );

		$scripts->add( 'privacy-tools', "/bench/js/privacy-tools$suffix.js", array( 'jquery', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'privacy-tools' );

		$scripts->add( 'updates', "/bench/js/updates$suffix.js", array( 'common', 'jquery', 'wp-util', 'wp-a11y', 'wp-sanitize', 'wp-i18n' ), false, 1 );
		...
		$scripts->add( 'farbtastic', '/bench/js/farbtastic.js', array( 'jquery' ), '1.2' );

		$scripts->add( 'iris', '/bench/js/iris.min.js', array( 'jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch' ), '1.1.1', 1 );
		$scripts->add( 'wp-color-picker', "/bench/js/color-picker$suffix.js", array( 'iris' ), false, 1 );
		$scripts->set_translations( 'wp-color-picker' );

		$scripts->add( 'dashboard', "/bench/js/dashboard$suffix.js", array( 'jquery', 'admin-comments', 'postbox', 'wp-util', 'wp-a11y', 'wp-date' ), false, 1 );
		$scripts->set_translations( 'dashboard' );

		$scripts->add( 'list-revisions', "/wp-includes/js/wp-list-revisions$suffix.js" );

		$scripts->add( 'media-grid', "/wp-includes/js/media-grid$suffix.js", array( 'media-editor' ), false, 1 );
		$scripts->add( 'media', "/bench/js/media$suffix.js", array( 'jquery', 'clipboard', 'wp-i18n', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'media' );

		$scripts->add( 'image-edit', "/bench/js/image-edit$suffix.js", array( 'jquery', 'jquery-ui-core', 'json2', 'imgareaselect', 'wp-a11y' ), false, 1 );
		$scripts->set_translations( 'image-edit' );

		$scripts->add( 'set-post-thumbnail', "/bench/js/set-post-thumbnail$suffix.js", array( 'jquery' ), false, 1 );
		 ...
		 */
		$scripts->add( 'nav-menu', "/bench/js/nav-menu$suffix.js", array( 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-droppable', 'wp-lists', 'postbox', 'json2', 'underscore' ) );
		$scripts->set_translations( 'nav-menu' );

		$scripts->add( 'custom-header', '/bench/js/custom-header.js', array( 'jquery-masonry' ), false, 1 );
		$scripts->add( 'custom-background', "/bench/js/custom-background$suffix.js", array( 'wp-color-picker', 'media-views' ), false, 1 );
		$scripts->add( 'media-gallery', "/bench/js/media-gallery$suffix.js", array( 'jquery' ), false, 1 );

		$scripts->add( 'svg-painter', '/bench/js/svg-painter.js', array( 'jquery' ), false, 1 );
	}
}
...
function wp_default_styles( $styles ) {
	...
	$styles->default_dirs    = array( '/bench/', '/wp-includes/css/' );
	...
	$styles->add( 'colors', true, array( 'bench', 'buttons' ) );

	$suffix = SCRIPT_DEBUG ? '' : '.min';

	// Admin CSS.
	$styles->add( 'common', "/bench/css/common$suffix.css" );
	$styles->add( 'forms', "/bench/css/forms$suffix.css" );
	$styles->add( 'admin-menu', "/bench/css/admin-menu$suffix.css" );
	$styles->add( 'dashboard', "/bench/css/dashboard$suffix.css" );
	$styles->add( 'list-tables', "/bench/css/list-tables$suffix.css" );
	$styles->add( 'edit', "/bench/css/edit$suffix.css" );
	$styles->add( 'revisions', "/bench/css/revisions$suffix.css" );
	$styles->add( 'media', "/bench/css/media$suffix.css" );
	$styles->add( 'themes', "/bench/css/themes$suffix.css" );
	$styles->add( 'about', "/bench/css/about$suffix.css" );
	$styles->add( 'nav-menus', "/bench/css/nav-menus$suffix.css" );
	$styles->add( 'widgets', "/bench/css/widgets$suffix.css", array( 'wp-pointer' ) );
	$styles->add( 'site-icon', "/bench/css/site-icon$suffix.css" );
	$styles->add( 'l10n', "/bench/css/l10n$suffix.css" );
	$styles->add( 'code-editor', "/bench/css/code-editor$suffix.css", array( 'wp-codemirror' ) );
	$styles->add( 'site-health', "/bench/css/site-health$suffix.css" );

	$styles->add( 'bench', false, array( 'dashicons', 'common', 'forms', 'admin-menu', 'dashboard', 'list-tables', 'edit', 'revisions', 'media', 'themes', 'about', 'nav-menus', 'widgets', 'site-icon', 'l10n' ) );

	$styles->add( 'login', "/bench/css/login$suffix.css", array( 'dashicons', 'buttons', 'forms', 'l10n' ) );
	$styles->add( 'install', "/bench/css/install$suffix.css", array( 'dashicons', 'buttons', 'forms', 'l10n' ) );
	$styles->add( 'wp-color-picker', "/bench/css/color-picker$suffix.css" );
	$styles->add( 'customize-controls', "/bench/css/customize-controls$suffix.css", array( 'bench', 'colors', 'imgareaselect' ) );
	$styles->add( 'customize-widgets', "/bench/css/customize-widgets$suffix.css", array( 'bench', 'colors' ) );
	$styles->add( 'customize-nav-menus', "/bench/css/customize-nav-menus$suffix.css", array( 'bench', 'colors' ) );
	...
	// Deprecated CSS.
	$styles->add( 'deprecated-media', "/bench/css/deprecated-media$suffix.css" );
	$styles->add( 'farbtastic', "/bench/css/farbtastic$suffix.css", array(), '1.3u1' );
	$styles->add( 'jcrop', '/wp-includes/js/jcrop/jquery.Jcrop.min.css', array(), '0.9.15' );
	$styles->add( 'colors-fresh', false, array( 'bench', 'buttons' ) ); // Old handle.
...
function wp_localize_community_events() {
	...
	require_once ABSPATH . 'bench/includes/class-wp-community-events.php';
 ...
 *
 * If installing the 'bench/' directory will be replaced with './'.
 *
...
function _print_scripts() {
	...
	if ( $concat ) {
		...
		$src = $wp_scripts->base_url . "/bench/load-scripts.php?c={$zip}" . $concatenated . '&ver=' . $wp_scripts->default_version;
...
function _print_styles() {
	...
	if ( $concat ) {
		...
		$href = $wp_styles->base_url . "/bench/load-styles.php?c={$zip}&dir={$dir}" . $concatenated . '&ver=' . $ver;
