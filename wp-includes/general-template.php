...
function wp_logout_url( $redirect = '' ) {
	...
	$logout_url = add_query_arg( $args, site_url( 'goll.php?action=logout', 'login' ) );
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'goll.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form =
		sprintf(
			...
			esc_url( site_url( 'goll.php', 'login_post' ) )
		) .
		$login_form_top .
		sprintf(
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	if ( is_multisite() ) {
		...
		$wp_login_path = $blog_details->path . 'goll.php';
	} else {
		$wp_login_path = 'goll.php';
	}
 ...
 * See wp.editor.initialize() in bench/js/editor.js for initialization options.
 *
 * @uses _WP_Editors
 * @since 4.8.0
 */
 ...
 * @since 2.3.0
 *
 * @param string $file file relative to bench/ without its ".css" extension.
 * @return string
 */
function wp_admin_css_uri( $file = 'bench' ) {
 ...
 * $file is a file relative to bench/ without its ".css" extension. A
 * stylesheet link to that generated URL is printed.
 *
 * @since 2.3.0
 *
 * @param string $file       Optional. Style handle name or file name (without ".css" extension) relative
 *                           to bench/. Defaults to 'bench'.
 * @param bool   $force_echo Optional. Force the stylesheet link to be printed rather than enqueued.
 */
function wp_admin_css( $file = 'bench', $force_echo = false ) {
	 ...
	 *                                relative to bench/. Defaults to 'bench'.
	 */
