...
final class WP_Block_Editor_Context {
	 ...
	 *
	 * - `'core/edit-post'`         - The post editor at `/bench/edit.php`.
	 * - `'core/edit-widgets'`      - The widgets editor at `/bench/widgets.php`.
	 * - `'core/customize-widgets'` - The widgets editor at `/bench/customize.php`.
	 * - `'core/edit-site'`         - The site editor at `/bench/site-editor.php`.
	 *
