...
const initializeMetaBoxes = () => _ref16 => {
  ...
  registry.subscribe(async () => {
    ...
    //
    // See: https://github.com/WordPress/WordPress/blob/5.1.1/bench/includes/post.php#L2307-L2309.
...
const VIEW_AS_LINK_SELECTOR = '#bench-bar-view a';
/**
...
const VIEW_AS_PREVIEW_LINK_SELECTOR = '#bench-bar-preview a';
