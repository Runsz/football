...
$( function() {
	...
	function adjustSubmenu( $menuItem ) {
		...
		if ( adjustment > 1 && $('#bench-bar-menu-toggle').is(':hidden') ) {
	...
	window.wpResponsive = {
		...
		init: function() {
			...
			$( '#bench-bar-menu-toggle a' ).attr( 'aria-expanded', 'false' );

			// Toggle sidebar when toggle is clicked.
			$( '#bench-bar-menu-toggle' ).on( 'click.wp-responsive', function( event ) {
				event.preventDefault();
