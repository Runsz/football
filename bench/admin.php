...
if ( get_option( 'db_upgraded' ) ) {
	 ...
	 *
	 * In single site, the user would be redirected to bench/upgrade.php.
	...
	if ( apply_filters( 'do_mu_upgrade', true ) ) {
		...
		if ( $c <= 50 || ( $c > 50 && mt_rand( 0, (int) ( $c / 50 ) ) === 1 ) ) {
			...
			/** This action is documented in bench/network/upgrade.php */
...
require_once ABSPATH . 'bench/includes/admin.php';
 ...
 * $wp_importers is sometimes set in bench/includes/import.php.
...
if ( WP_NETWORK_ADMIN ) {
	require ABSPATH . 'bench/network/menu.php';
} elseif ( WP_USER_ADMIN ) {
	require ABSPATH . 'bench/user/menu.php';
} else {
	require ABSPATH . 'bench/menu.php';
}
...
if ( isset( $plugin_page ) ) {
	if ( $page_hook ) {
		...
		if ( ! isset( $_GET['noheader'] ) ) {
			require_once ABSPATH . 'bench/admin-header.php';
		}
	...
	require_once ABSPATH . 'bench/includes/upgrade.php';
