...
require_once ABSPATH . 'bench/includes/edit-tag-messages.php';
...
<?php if ( is_taxonomy_hierarchical( $taxonomy ) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in bench/edit-tags.php */
...
// Back compat hooks.
if ( 'category' === $taxonomy ) {
	/** This action is documented in bench/edit-tags.php */
