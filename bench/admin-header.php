 ...
 * 2. Not all core admin classes are filterable, notably: bench, wp-core-ui,
...
?>
<body class="bench wp-core-ui no-js <?php echo $admin_body_classes; ?>">
<script type="text/javascript">
...
<div id="wpwrap">
<?php require ABSPATH . 'bench/menu-header.php'; ?>
<div id="wpcontent">
...
if ( 'options-general.php' === $parent_file ) {
	require ABSPATH . 'bench/options-head.php';
}
