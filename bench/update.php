...
if ( isset( $_GET['action'] ) ) {
	...
	if ( 'update-selected' === $action ) {
		...
		include_once ABSPATH . 'bench/includes/plugin-install.php'; // For plugins_api().
		...
		include_once ABSPATH . 'bench/includes/class-wp-upgrader.php'; // For themes_api().
		 ...
		 * provided in the request for bench/update.php. Can be used to
