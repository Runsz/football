...
class WP_Site_Health {
	...
	public function show_site_health_tab( $tab ) {
		if ( 'debug' === $tab ) {
			require_once ABSPATH . '/bench/site-health-info.php';
		}
	}
	...
	public function get_test_background_updates() {
		...
		if ( ! class_exists( 'WP_Site_Health_Auto_Updates' ) ) {
			require_once ABSPATH . 'bench/includes/class-wp-site-health-auto-updates.php';
		}
	...
	public static function get_tests() {
		 ...
		 * to complete should run asynchronously, to avoid extended loading periods within bench.
		 *
		 * @since 5.2.0
	...
	public function wp_cron_scheduled_check() {
		// Bootstrap bench, as WP_Cron doesn't do this for us.
		require_once trailingslashit( ABSPATH ) . 'bench/includes/admin.php';
