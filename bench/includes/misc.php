...
function wp_admin_canonical_url() {
	...
	?>
	<link id="bench-canonical" rel="canonical" href="<?php echo esc_url( $filtered_url ); ?>" />
	<script>
		if ( window.history.replaceState ) {
			window.history.replaceState( null, null, document.getElementById( 'bench-canonical' ).href + window.location.hash );
		}
	</script>
	<?php
}
 ...
 *
 * @since 3.0.0
 * @since 4.9.0 This function was moved from bench/includes/ms.php so it's no longer Multisite specific.
 *
