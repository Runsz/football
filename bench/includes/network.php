		...
		if ( is_multisite() && get_site_option( 'ms_files_rewriting' ) ) {
			...
			$web_config_file .= '
                <rule name="WordPress Rule 2" stopProcessing="true">
                    <match url="^' . $iis_subdir_match . 'bench$" ignoreCase="false" />
                    <action type="Redirect" url="' . $iis_subdir_replacement . 'bench/" redirectType="Permanent" />
                </rule>
...
{$ms_files_rewriting}
# add a trailing slash to /bench
RewriteRule ^{$subdir_match}bench$ {$subdir_replacement_01}bench/ [R=301,L]
