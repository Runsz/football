...
require_once ABSPATH . 'bench/includes/translation-install.php';
...
if ( $_POST ) {
	/** This action is documented in bench/network/edit.php */
...
<?php require_once ABSPATH . 'bench/admin-footer.php'; ?>
