...
if ( isset( $_GET['page'] ) && ! empty( $_POST ) ) {
	...
	if ( 'export_personal_data' === $_GET['page'] ) {
		require_once ABSPATH . 'bench/export-personal-data.php';
		return;
	} elseif ( 'remove_personal_data' === $_GET['page'] ) {
		require_once ABSPATH . 'bench/erase-personal-data.php';
		return;
	}
}

// The privacy policy guide used to be outputted from here. Since WP 5.3 it is in bench/privacy-policy-guide.php.
